...
// TestGetPCLQsByNames was removed because the GetPCLQsByNames function doesn't exist in the implementation.
...
func TestGetPodCliquesWithParentPGS(t *testing.T) {
	...
	pgsLabels := map[string]string{
		...
		apicommon.LabelPartOfKey:    testPGSNamePodClique,
	...
	tests := []testCase{
		{
			...
			inputPCLQs: []grovecorev1alpha1.PodClique{
				createTestPodClique("pclq-1", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGang: "gang-a"}, nil),
				createTestPodClique("pclq-2", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGang: "gang-a"}, nil),
				createTestPodClique("pclq-3", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGang: "gang-b"}, nil),
			},
			expectedGroups: map[string][]string{
		...
		},
		{
			...
			inputPCLQs: []grovecorev1alpha1.PodClique{
				createTestPodClique("pclq-1", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGang: "gang-single"}, nil),
			},
			expectedGroups: map[string][]string{
				"gang-single": {"pclq-1"},
			},
	...
	tests := []testCase{
		{
			...
			inputPCLQs: []grovecorev1alpha1.PodClique{
				createTestPodClique("pclq-1", testNamespacePodClique,
					map[string]string{apicommon.LabelPodCliqueScalingGroupReplicaIndex: "0"}, nil),
				createTestPodClique("pclq-2", testNamespacePodClique,
					map[string]string{apicommon.LabelPodCliqueScalingGroupReplicaIndex: "0"}, nil),
				createTestPodClique("pclq-3", testNamespacePodClique,
					map[string]string{apicommon.LabelPodCliqueScalingGroupReplicaIndex: "1"}, nil),
			},
			expectedGroups: map[string][]string{
				"0": {"pclq-1", "pclq-2"},
				"1": {"pclq-3"},
	...
	tests := []testCase{
		{
			...
			inputPCLQs: []grovecorev1alpha1.PodClique{
				createTestPodClique("pclq-1", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGangSetReplicaIndex: "0"}, nil),
				createTestPodClique("pclq-2", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGangSetReplicaIndex: "0"}, nil),
				createTestPodClique("pclq-3", testNamespacePodClique,
					map[string]string{apicommon.LabelPodGangSetReplicaIndex: "1"}, nil),
			},
			expectedGroups: map[string][]string{
				"0": {"pclq-1", "pclq-2"},
				"1": {"pclq-3"},
