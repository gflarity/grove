...
func TestNew(t *testing.T) {
	...
	_, ok := operator.(component.Operator[grovecorev1alpha1.PodGangSet])
	assert.True(t, ok, "New should return an operator that implements component.Operator[PodGangSet]")
}
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedLabels: map[string]string{
				grovecorev1alpha1.LabelManagedByKey:           grovecorev1alpha1.LabelManagedByValue,
				grovecorev1alpha1.LabelPartOfKey:              "test-pgs",
				grovecorev1alpha1.LabelAppNameKey:             "test-pgs-0",
				grovecorev1alpha1.LabelComponentKey:           component.NamePodGangHeadlessService,
		...
		},
		{
			...
			expectedLabels: map[string]string{
				grovecorev1alpha1.LabelManagedByKey:           grovecorev1alpha1.LabelManagedByValue,
				grovecorev1alpha1.LabelPartOfKey:              "my-workload",
				grovecorev1alpha1.LabelAppNameKey:             "my-workload-5",
				grovecorev1alpha1.LabelComponentKey:           component.NamePodGangHeadlessService,
	...
	tests := []struct {
		...
		},
		{
			...
			expectedSelector: map[string]string{
				grovecorev1alpha1.LabelManagedByKey:           grovecorev1alpha1.LabelManagedByValue,
				grovecorev1alpha1.LabelPartOfKey:              "my-workload",
				grovecorev1alpha1.LabelPodGangSetReplicaIndex: "3",
			},
		},
	}
...
func TestGetSelectorLabelsForAllHeadlessServices(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedSelector: map[string]string{
				grovecorev1alpha1.LabelManagedByKey: grovecorev1alpha1.LabelManagedByValue,
				grovecorev1alpha1.LabelPartOfKey:    "my-complex-workload-v2",
				grovecorev1alpha1.LabelComponentKey: component.NamePodGangHeadlessService,
			},
		},
	}
...
func TestGetObjectKeys(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			pgs: testutils.NewPodGangSetBuilder("my-workload", "production").
				WithReplicas(3).
				Build(),
			expectedKeys: []client.ObjectKey{
		...
		},
		{
			...
			pgs: testutils.NewPodGangSetBuilder("empty-pgs", "default").
				WithReplicas(0).
				Build(),
			expectedKeys: []client.ObjectKey{},
		},
...
func TestBuildResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			serviceName := grovecorev1alpha1.GenerateHeadlessServiceName(grovecorev1alpha1.ResourceNameReplica{
				Name:    tt.pgs.Name,
