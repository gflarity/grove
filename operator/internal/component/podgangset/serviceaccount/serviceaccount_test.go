...
func TestGetExistingResourceNames(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			existingServiceAccounts: []client.Object{
				&corev1.ServiceAccount{
					ObjectMeta: metav1.ObjectMeta{
						Name:      grovecorev1alpha1.GeneratePodServiceAccountName("test-pgs"),
						Namespace: "default",
			...
			expectedNames: []string{grovecorev1alpha1.GeneratePodServiceAccountName("test-pgs")},
			expectError:   false,
		},
		{
	...
	tests := []struct {
	...
	}{
		{
			...
			validateServiceAccount: func(t *testing.T, sa *corev1.ServiceAccount, pgs *grovecorev1alpha1.PodGangSet) {
				...
				assert.Equal(t, grovecorev1alpha1.GeneratePodServiceAccountName(pgs.Name), sa.Name)
				assert.Equal(t, pgs.Namespace, sa.Namespace)

				// Verify labels
				expectedLabels := map[string]string{
					grovecorev1alpha1.LabelManagedByKey: grovecorev1alpha1.LabelManagedByValue,
					grovecorev1alpha1.LabelPartOfKey:    pgs.Name,
					grovecorev1alpha1.LabelComponentKey: component.NamePodServiceAccount,
					grovecorev1alpha1.LabelAppNameKey:   grovecorev1alpha1.GeneratePodServiceAccountName(pgs.Name),
				}
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectError {
				...
				objectKey := client.ObjectKey{
					Name:      grovecorev1alpha1.GeneratePodServiceAccountName(tt.pgs.Name),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectError {
				...
				sa := &corev1.ServiceAccount{}
				objectKey := client.ObjectKey{
					Name:      grovecorev1alpha1.GeneratePodServiceAccountName(tt.pgsObjMeta.Name),
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedLabels: map[string]string{
				...
				grovecorev1alpha1.LabelComponentKey: component.NamePodServiceAccount,
				grovecorev1alpha1.LabelAppNameKey:   grovecorev1alpha1.GeneratePodServiceAccountName("test-pgs"),
			},
		},
		{
			...
			expectedLabels: map[string]string{
				grovecorev1alpha1.LabelManagedByKey: grovecorev1alpha1.LabelManagedByValue,
				grovecorev1alpha1.LabelPartOfKey:    "my-application",
				grovecorev1alpha1.LabelComponentKey: component.NamePodServiceAccount,
				grovecorev1alpha1.LabelAppNameKey:   grovecorev1alpha1.GeneratePodServiceAccountName("my-application"),
			},
		},
	}
...
func TestGetObjectKey(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedObjectKey: client.ObjectKey{
				Name:      grovecorev1alpha1.GeneratePodServiceAccountName("production-app"),
				Namespace: "production",
			},
		},
	}
