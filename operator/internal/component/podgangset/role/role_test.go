...
func TestGetExistingResourceNames(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			existingRoles: []rbacv1.Role{
				{
					ObjectMeta: metav1.ObjectMeta{
						Name:      grovecorev1alpha1.GeneratePodRoleName("test-pgs"),
						Namespace: "test-ns",
			...
			expectedNames: []string{grovecorev1alpha1.GeneratePodRoleName("test-pgs")},
			expectError:   false,
		},
		{
...
func TestGetLabels(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedLabels: func() map[string]string {
				...
				defaultLabels := k8sutils.GetDefaultLabelsForPodGangSetManagedResources("test-pgs")
				roleLabels := map[string]string{
					grovecorev1alpha1.LabelComponentKey: component.NamePodRole,
					grovecorev1alpha1.LabelAppNameKey:   strings.ReplaceAll(grovecorev1alpha1.GeneratePodRoleName("test-pgs"), ":", "-"),
				}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, component.NamePodRole, labels[grovecorev1alpha1.LabelComponentKey], "Component label should be pod-role")
