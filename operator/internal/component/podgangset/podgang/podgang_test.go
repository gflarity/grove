	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.shouldError {
				...
				assert.Contains(t, pg.Labels, apicommon.LabelComponentKey, "PodGang should have component label")
				assert.Equal(t, apicommon.LabelComponentNamePodGang, pg.Labels[apicommon.LabelComponentKey], "Component label should be correct")
...
func TestGetPodGangSelectorLabels(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedLabels: map[string]string{
				apicommon.LabelComponentKey: apicommon.LabelComponentNamePodGang,
				apicommon.LabelPartOfKey:    "test-pgs-with-dashes",
				apicommon.LabelManagedByKey: apicommon.LabelManagedByValue,
			},
		},
	}
...
func TestGetLabels(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedLabels: map[string]string{
				apicommon.LabelComponentKey: apicommon.LabelComponentNamePodGang,
				apicommon.LabelPartOfKey:    "complex-pgs-name-with-dashes",
				apicommon.LabelManagedByKey: apicommon.LabelManagedByValue,
			},
		},
	}
