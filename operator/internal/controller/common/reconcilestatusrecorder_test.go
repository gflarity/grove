...
func TestRecordStart(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedEventReason:  constants.EventReconciling,
		...
		},
		{
			...
			patchShouldFail:      false,
			expectedEventReason:  constants.EventDeleting,
...
func TestRecordCompletion(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedEventReason:    constants.EventReconciled,
		...
		},
		{
			...
			patchShouldFail:        false,
			expectedEventType:      v1.EventTypeNormal,
			expectedEventReason:    constants.EventDeleted,
		...
		},
		{
			...
			expectedEventReason:    constants.EventReconcileError,
		...
		},
		{
			...
			patchShouldFail:        false,
			expectedEventType:      v1.EventTypeWarning,
			expectedEventReason:    constants.EventDeleteError,
...
func TestGetCompletionEventReason(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			operationType:   grovecorev1alpha1.LastOperationTypeReconcile,
			operationResult: nil,
			expectedReason:  constants.EventReconciled,
		},
		{
			...
			operationType:   grovecorev1alpha1.LastOperationTypeDelete,
			operationResult: nil,
			expectedReason:  constants.EventDeleted,
		},
		{
			...
			expectedReason: constants.EventReconcileError,
		},
		{
			...
			expectedReason: constants.EventDeleteError,
		},
		{
