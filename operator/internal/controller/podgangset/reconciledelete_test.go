	...
	tests := []struct {
	...
	}{
		{
			...
			setupMocks: func(registry *mockOperatorRegistry, recorder *mockReconcileStatusRecorder) {
				...
				mockOp.On("Exists", mock.Anything, mock.Anything).Return(false, nil)
		...
		},
		{
			...
			setupMocks: func(registry *mockOperatorRegistry, recorder *mockReconcileStatusRecorder) {
				...
				mockOp.On("Exists", mock.Anything, mock.Anything).Return(true, nil)                                                            // Resources still exist
	...
	tests := []struct {
		...
		},
		{
			...
			setupMock: func(registry *mockOperatorRegistry) {
				...
				mockOp.On("Exists", mock.Anything, mock.Anything).Return(true, nil)
		...
		},
		{
			...
			setupMock: func(registry *mockOperatorRegistry) {
				...
				mockOp.On("Exists", mock.Anything, mock.Anything).Return(false, errors.New("check failed"))
