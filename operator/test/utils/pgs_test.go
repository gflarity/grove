...
func TestNewPodGangSetBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			builder := NewPodGangSetBuilder(tt.pgsName, tt.namespace)
...
func TestPodGangSetBuilder_WithCliqueStartupType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			builder := NewPodGangSetBuilder("test-pgs", "default")
...
func TestPodGangSetBuilder_Chaining(t *testing.T) {
	...
	pgs := NewPodGangSetBuilder("complex-pgs", "production").
		WithReplicas(10).
...
func TestPodGangSetBuilder_UIDGeneration(t *testing.T) {
	builder1 := NewPodGangSetBuilder("pgs-1", "default")
	builder2 := NewPodGangSetBuilder("pgs-2", "default")
