...
func loadForestDataCmd(provider DataProvider, ctx context.Context) tea.Cmd {
	return func() tea.Msg {
		debugLogCmd("loadForestData")
		if provider == nil {
			debugLogWithContext("loadForestData: no provider")
			return ForestDataMsg{Resources: []Resource{}, Err: nil}
		}
...
func loadReplicasCmd(provider DataProvider, ctx context.Context, pcsName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadReplicaChildrenCmd(provider DataProvider, ctx context.Context, pcsName, namespace, replicaIndex string) tea.Cmd {
	return func() tea.Msg {
...
func loadPCSGChildrenCmd(provider DataProvider, ctx context.Context, pcsgName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadPodCliqueChildrenCmd(provider DataProvider, ctx context.Context, pcName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadEventsForPCSCmd(provider DataProvider, ctx context.Context, pcsName, namespace string) tea.Cmd {
	return func() tea.Msg {
		debugLogCmd("loadEventsForPCS", "pcs", pcsName, "ns", namespace)
		if provider == nil {
			return EventsMsg{Events: []Event{}}
		}
...
func loadEventsForReplicaCmd(provider DataProvider, ctx context.Context, pcsName, namespace, replicaIndex string) tea.Cmd {
	return func() tea.Msg {
...
func loadEventsForPCSGCmd(provider DataProvider, ctx context.Context, pcsgName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadEventsForPodCliqueCmd(provider DataProvider, ctx context.Context, pcName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadPodYAMLCmd(provider DataProvider, ctx context.Context, podName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadTopologyInfoCmd(provider DataProvider, ctx context.Context, pcsName, namespace string) tea.Cmd {
	return func() tea.Msg {
		...
		topologyInfo := BuildTopologyInfo(pcs)
...
func loadPodInfoCmd(provider DataProvider, ctx context.Context, pcsName, namespace string) tea.Cmd {
	return func() tea.Msg {
...
func loadNodeLabelsCmd(provider DataProvider, ctx context.Context, topologyInfo *TopologyInfo) tea.Cmd {
	return func() tea.Msg {
