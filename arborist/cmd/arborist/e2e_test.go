...
func setupE2E(t *testing.T) (DataProvider, *kubernetes.Clientset) {
	t.Helper()
...
func newE2ETestModel(t *testing.T, provider DataProvider) *teatest.TestModel {
	t.Helper()
